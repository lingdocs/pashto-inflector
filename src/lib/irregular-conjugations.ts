...
export const kedulStat: T.VerbConjugation = {
    ...
    imperfective: {
        ...
        habitualPast: {
            ...
            long: [
                [[{p: "به کېدلم", f: "ba kedulum"}], [{p: "به کېدلو", f: "ba keduloo"}]],
                [[{p: "به کېدلم", f: "ba kedulum"}], [{p: "به کېدلو", f: "ba keduloo"}]],
                [[{p: "به کېدلې", f: "ba kedule"}], [{p: "به کېدلئ", f: "ba keduleyy"}]],
                [[{p: "به کېدلې", f: "ba kedule"}], [{p: "به کېدلئ", f: "ba keduleyy"}]],
                [[{p: "به کېدله", f: "ba kedulu"}, {p: "به کېدلو", f: "ba kedulo"}], [{p: "به کېدل", f: "ba kedul"}]],
                [[{p: "به کېدله", f: "ba kedula"}], [{p: "به کېدلې", f: "ba kedule"}]],
            ],
        },
