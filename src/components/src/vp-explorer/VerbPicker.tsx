...
function VerbPicker(props: {
  ...
  const infoRaw = getVerbInfo(props.vps.verb.verb.entry, props.vps.verb.verb.complement);
  const info = "stative" in infoRaw
    ? infoRaw[
  ...
  const passiveRootsAndStems = props.vps.verb.voice === "passive"
    ? getPassiveRootsAndStems(info)
    : undefined;
  const abilityRootsAndStems = (() => {
    try {
      return props.vps.verb.tenseCategory === "modal"
    ...
    <div className="mb-3">
      ...
      <div className="mt-3 mb-1 text-center">
        <Hider
          ...
          label={`🌳 ${passiveRootsAndStems
            ? "Passive"
            : abilityRootsAndStems
              ? "Ability"
              : ""
            } Roots and Stems${info.type === "dynamic compound" ? " for Aux. Verb" : ""
            }`}
      ...
      >
        {props.vps.verb.canChangeTransitivity && (
        ...
        {props.vps.verb.canChangeStatDyn && (
          <div className="text-center my-2">
            <ButtonSelect
              small
              options={[
              ...
              value={
                props.vps.verb.isCompound === "generative stative"
                  ? "stative"
                  : props.vps.verb.isCompound === false ? "stative" : props.vps.verb.isCompound
              }
